            ...
            <ul id="accordion-menu">
                ...
                <li class="mt-2">
                    <a href="{{ route('home') }}"
                        ...
                        <span class="micon dw dw-home"></span><span
                            class="mtext">{{ auth()->user()->company_name }}</span>
                    </a>
                </li>
                {{-- Divider --}}
                <li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="{{ route('ledger-head.index') }}"
                                class="{{ Request::routeIs('ledger-head.*') ? 'active' : '' }}">Ledgers
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="{{ route('voucher.accounting.create') }}"
                                class="{{ Request::routeIs('voucher.accounting.*') ? 'active' : '' }}">
                                Accounting
                                Vouchers
                            </a>
                        </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="{{ route('report.balance-sheet.index') }}"
                                class="{{ Request::routeIs('report.balance-sheet.*') ? 'active' : '' }}">
                                Balance Sheet
                            </a>
                        </li>
                        <li>
