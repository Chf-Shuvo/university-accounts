...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-12 alert alert-info text-center">
            <h2>Account Vouchers</h2>
        </div>
        <div class="col-md-12 col-12">
            <form action="{{ route('voucher.accounting.store') }}" method="post" enctype="multipart/form-data"
                id="voucherForm">
                @csrf
                <div class="form-row">
                    <div class="form-group col-md-12 col-12">
                        <label for="">Period:</label>
                        <input type="text" name="date" class="form-control date-picker" autocomplete="off" id="entryPeriod">
                    </div>
                    <div class="form-group col-md-12 col-12">
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered" id="dynamicTable">
                            ...
                            <tr class="dataRow">
                                <td><select name="account_type[]" id="" class="form-control accountType"
                                ...
                                <td><input type="number" name="amount[]" placeholder="Amount"
                                        class="form-control amountField" value="0" onkeyup="amountCalculation()" /></td>
                            </tr>
                            <tr>
                                <td>
                                    Narration:
                                ...
                                <td>
                                    ...
                                    <span class="font-weight-bold float-right">Credit: <span
                                            id="creditAmount"></span></span>
                                    <input type="hidden" name="total_amount" id="total_amount">
                                </td>
                            </tr>
                        </table>
                        <button type="button" id="remove" class="btn btn-danger float-right ml-2" data-toggle="tooltip"
                            data-placement="top" title="remove last Dr/Cr entry field"><i
                                class="icon-copy dw dw-cancel"></i>
                            Particular</button>
                        <button type="button" id="add" class="btn btn-success float-right" data-toggle="tooltip"
                            data-placement="top" title="add new Dr/Cr entry field"><i class="icon-copy dw dw-add"></i>
                            Particular</button>
                    </div>

                    <div class="form-group col-md-12 col-12 mt-3">
                        <button type="button" class="btn btn-success btn-md float-right"
                            onclick="submitVoucherForm()">submit</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        function submitVoucherForm() {
            ...
            let permittedEntryDate =
                "{{ Carbon\Carbon::parse(auth()->user()->company_last_entry_date)->format('Y-m-d') }}"
