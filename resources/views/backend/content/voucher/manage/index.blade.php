    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <a href="javascript:void(0)" class="btn btn-info btn-md m-3 float-right" data-toggle="modal"
                data-target="#dataModal"><i class="icon-copy dw dw-add"></i> add new voucher type</a>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('voucher.manage.store') }}" method="post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12 col-12">
                                        ...
                                        <input type="text" class="form-control" name="name"
                                            placeholder="Journal/Bank Payment/Cash Payment" data-validation="required">
                                    </div>
                ...
                <tbody>
                    @foreach ($vouchers as $item)
                        <tr>
                            ...
                            <td>{{ $item->name }}</td>
                            <td>
                                <a href="{{ route('voucher.manage.edit', $item->id) }}" class="btn btn-warning btn-sm"><i
