...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-12">
      <a href="javascript:void(0)" class="btn btn-info btn-md m-3 float-right" data-toggle="modal" data-target="#dataModal"><i class="icon-copy dw dw-add"></i> add new head</a>
              ...
              <form action="{{ route('ledger-head.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12 col-12">
                    ...
                    <select name="parent_id" class="custom-select2 form-control" style="width: 100%;height:38px" id="ledger_parent">
                  ...
                  <div class="form-group col-md-12 col-12 d-none" id="visibility_order">
                    ...
                    <input type="number" min="1" name="visibility_order" class="form-control" value="1">
                  </div>
                  <div class="form-group col-md-12 col-12">
