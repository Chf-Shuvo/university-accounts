      ...
      <form action="{{ route('company.update', $user->company) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="name" class="form-control" value="{{ $current_company->name }}" data-validation="required">
          </div>
          <div class="form-group col-md-6">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="last_entry_date" class="form-control date-picker" value="{{ $current_company->last_entry_date }}" data-validation="date">
          </div>
          <div class="form-group col-md-12">
